        ...
        with open(filename_dw, mode='w', newline='') as file_dw:
            ...
            for iloop in range(nloop):
                ...
                with open(csv_file_path, 'a', newline='') as file_res:
                    ...
                    writer_res.writerow([omegagauss, ts, b, pqif, seed, iloop, sigma2, tau_rec, 
...
if __name__ == '__main__':
    ...
    print("="*70)
    print("INICIANDO SIMULACIONES PARALELIZADAS - MÚLTIPLES TS Y PQIF")
    print("="*70)
    ...
    print(f"Paralelizando sobre todas las combinaciones ts x pqif\n")
